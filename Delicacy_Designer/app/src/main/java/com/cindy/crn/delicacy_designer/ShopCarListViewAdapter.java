...
public class ShopCarListViewAdapter extends BaseAdapter {
    ...
    public ShopCarListViewAdapter(Context context, List<Map<String, Object>> listItems) {
        this.context = context;
        listContainer = LayoutInflater.from(context); // 创建视图容器并设置上下文
        this.listItems = listItems;
        hasChecked = new boolean[getCount()];
        reason = new String[getCount()];
    }
    ...
    public String getReason(int arg0) {
        return reason[arg0];
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.shop_car_item, null);
            // 获取控件对象
...
//					.findViewById(R.id.imageItem);
            ...
            listItemView.detail = (EditText) convertView
...
//				position).get("image"));
        ...
        if (((String) listItems.get(position).get("check")).equals("true")) {
            listItemView.check.setChecked(true);
            hasChecked[selectID] = true;
        } else {
            listItemView.check.setChecked(false);
            hasChecked[selectID] = false;
        }
        ...
        listItemView.check
                .setOnCheckedChangeListener(new CheckBox.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView,
                        ...
                        ShopCarActivity.update();
                    }
                });

        listItemView.detail.addTextChangedListener(new TextWatcher() {

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                // TODO Auto-generated method stub
                System.out.println(s);
                reason[selectID] = s.toString();
            }
